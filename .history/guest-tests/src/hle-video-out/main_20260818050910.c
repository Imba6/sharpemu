...
int main(void)
{
    ...
    /*
     * Put something non-zero into the framebuffer.
     */
    framebuffer[0] = 0xFFFF0000u;
    framebuffer[1] = 0xFF00FF00u;
    framebuffer[2] = 0xFF0000FFu;
    ...
    /*
     * Verify that VideoOut actually recorded the flip.
     */
