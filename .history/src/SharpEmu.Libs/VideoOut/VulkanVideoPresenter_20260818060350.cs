...
using static SharpEmu.Libs.VideoOut.VideoOutExports;
    ...
    out GuestImageResource? image)
{
    ...
    Console.Error.WriteLine(
        $"[VPS5][CPUFB] bootstrap enter addr=0x{address:X16}");

    if (address == 0)
    {
        Console.Error.WriteLine(
            "[VPS5][CPUFB] FAIL: address=0");
        return false;
    }
    ...
    {
        Console.Error.WriteLine(
            $"[VPS5][CPUFB] FAIL: display buffer metadata not found " +
            $"addr=0x{address:X16}");
        return false;
    }
    ...
    Console.Error.WriteLine(
        ...
        $"fmt=0x{displayBuffer.PixelFormat:X16} " +
    ...
    {
        Console.Error.WriteLine(
            $"[VPS5][CPUFB] FAIL: tiling={displayBuffer.TilingMode}");
        return false;
    }
    ...
    {
        Console.Error.WriteLine(
            "[VPS5][CPUFB] FAIL: empty dimensions");
        return false;
    }

    if (displayBuffer.PitchInPixel != displayBuffer.Width)
    {
        Console.Error.WriteLine(
            $"[VPS5][CPUFB] FAIL: pitch mismatch " +
            $"pitch={displayBuffer.PitchInPixel} " +
    ...
    var pixelLayout =
        VideoOutExports.GetCpuDisplayPixelLayout(
            displayBuffer.PixelFormat);

    Console.Error.WriteLine(
        $"[VPS5][CPUFB] layout={pixelLayout}");
    ...
    {
        Console.Error.WriteLine(
            $"[VPS5][CPUFB] FAIL: unsupported pixel format " +
            $"0x{displayBuffer.PixelFormat:X16}");
        return false;
    }
    ...
    {
        Console.Error.WriteLine(
            "[VPS5][CPUFB] FAIL: guest memory not attached");
        return false;
    }

    Console.Error.WriteLine(
        "[VPS5][CPUFB] guest memory attached");

    var byteCount =
        checked(
            (ulong)displayBuffer.Width *
    ...
    {
        Console.Error.WriteLine(
            $"[VPS5][CPUFB] FAIL: framebuffer too large bytes={byteCount}");
        return false;
    }
    ...
    {
        Console.Error.WriteLine(
            $"[VPS5][CPUFB] FAIL: guest memory read " +
            $"addr=0x{address:X16} bytes={byteCount}");
        return false;
    }

    Console.Error.WriteLine(
        $"[VPS5][CPUFB] guest memory read OK bytes={byteCount}");
    ...
    Console.Error.WriteLine(
        $"[VPS5][CPUFB] creating GuestImageResource vk={imageFormat}");
    ...
    Console.Error.WriteLine(
        $"[VPS5][CPUFB] image created initialized={image.Initialized}");
    ...
    if (!image.Initialized)
    {
        ...
        Console.Error.WriteLine(
            $"[VPS5][CPUFB] initial upload done initialized={image.Initialized}");
    }
    ...
    Console.Error.WriteLine(
        $"[VPS5][CPUFB] SUCCESS addr=0x{address:X16}");
